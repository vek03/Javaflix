...
public class frm_manage_loc extends javax.swing.JFrame {
    ...
    public frm_manage_loc(int realId, String realUser, String realNome) {
        ...
        //enviando instrução SQL construtora para selecionar todas as locações do banco
        con_cliente.executaSQL("select * from locacao order by id");
        preencherTabela(); //chamando metodo que preenche a tabela com as locações
        ...
        reload(); //chamando metodo que seta um icone ao botão de recarregar
        logo(); //chamando metodo que seta a logo
        icone(); //chamando metood que seta o icone
    }
    ...
    private void initComponents() {
        ...
        tblClientes.setToolTipText("Locações");
        ...
        txtUser.setToolTipText("Usuário do cliente");
        ...
        txtFilme.setToolTipText("Filme alugado");
        ...
        aviso.setText("Só é possível alterar a data de devolução e o total da compra");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(119, 119, 119)
                                .addComponent(alert, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
    ...
    private void txtPesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisaKeyReleased
        ...
        //buscando um registro com os caracteres selecionados pelo usuario
        try {
    ...
    //metodo que atualiza o registro selecionado
    private void update(){
        ...
        LocalDate devol = LocalDate.parse(txtDevol.getText(), formatBra);
        String devolucao = devol.format(formatSql);
        ...
        try {
            sql="update locacao set data_devolucao='" + devolucao + "', total='" + total + "' where id = " + txtCod.getText();
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if(txtUser.getText().length() > 0 && txtFilme.getText().length() > 0 
            ...
            try{
                //testando se há apenas numeros no valor total do filme
                long teste;
                teste =  Long.parseLong(txtTotal.getText());

                //atualizando registro e reposicionando resultset
                update();
                alert.setText(null);
                con_cliente.executaSQL("select * from locacao order by id");
                con_cliente.resultset.first();
    ...
    //metodo que seta um icone ao botão de recarregar
    private void reload(){
        //método que traz a imagem na raiz do projeto
        //método getClass e getResourse são para puxar a imagem no arquivo .jar 
    ...
    //metodo que seta um icone ao programa
    private void icone(){
        //método que traz a imagem na raiz do projeto
        //método getClass e getResourse são para puxar a imagem no arquivo .jar 
